...
public class ServletScript extends ServletBase {
  ...
  protected void _GET_Request(HttpServletRequest  request,
                              HttpServletResponse response)
                                throws IOException
  {
    String script = request.getRequestURI().substring(
    ...
    switch (script) {
      ...
      case "message.js":
        ...
        returnResource("/web/js/" + script, response);
        break;
      
      default:
        log.warn("unknown js-resource, return 404 error");
