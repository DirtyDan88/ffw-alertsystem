...
JAVASRC="$LOCATION/../src/ffw/alertsystem/plugins/alertaction/AlertSMSInformer.java
...
BUILDFILE="$LOCATION/build-AlertSMSInformer-action.xml"

sh $LOCATION/../../core/build.sh "AlertSMSInformer-action" \
