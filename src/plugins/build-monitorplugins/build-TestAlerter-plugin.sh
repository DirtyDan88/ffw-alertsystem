...
JAVASRC="$LOCATION/../src/ffw/alertsystem/plugins/monitor/TestAlerter.java
         $LOCATION/../../util/src/ffw/alertsystem/util/DateAndTime.java"

BUILDFILE="$LOCATION/build-TestAlerter-plugin.xml"

sh $LOCATION/../../core/build.sh "TestAlerter-plugin" \
